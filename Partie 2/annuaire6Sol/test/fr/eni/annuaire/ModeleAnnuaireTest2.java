...
public class ModeleAnnuaireTest2 {
	...
	public static void main(String[] args) {
		...
		//ModeleAnnuaire annuaire = new Annuaire();
		ModeleAnnuaire annuaire = AnnuaireFactory.creerAnnuaire();
		...
		System.out.println("\n Test de l'annuaire de type Map");
